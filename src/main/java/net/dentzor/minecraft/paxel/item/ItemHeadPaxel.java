...
public class ItemHeadPaxel extends Item {
    ...
    public ItemHeadPaxel(String textureLocation, String textureName, CreativeTabs creativetab) {
        setHasSubtypes(true);
        setMaxDamage(0);
    ...
    public String getItemStackDisplayName(ItemStack is) {
        switch (is.getItemDamage()) {
            case 0:
                return "Wooden Paxelhead";
            case 1:
                return "Stone Paxelhead";
            case 2:
                return "Iron Paxelhead";
            case 3:
                return "Diamond Paxelhead";
            case 4:
                return "Golden Paxelhead";
            default:
                return "itemUnknown";
        }
    }
