...
public class ItemBodyPaxel extends Item {
    ...
    public ItemBodyPaxel(String textureLocation, String textureName, CreativeTabs creativetab) {
        setHasSubtypes(true);
        setMaxDamage(0);
    ...
    public String getItemStackDisplayName(ItemStack is) {
        switch (is.getItemDamage()) {
            case 0:
                return "Wooden Paxelbody";
            case 1:
                return "Stone Paxelbody";
            case 2:
                return "Iron Paxelbody";
            case 3:
                return "Diamond Paxelbody";
            case 4:
                return "Golden Paxelbody";
            default:
                return "itemUnknown";
        }
    }
