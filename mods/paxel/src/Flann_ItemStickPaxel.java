...
public class Flann_ItemStickPaxel extends Item {
	...
	public Icon tg;//Gold
	public String tex = "stickPaxel";
	public String texLoc;
	
	public Flann_ItemStickPaxel(int par1, String texLocation) {
		super(par1);
		setHasSubtypes(true);
		setMaxDamage(0);
		texLoc = texLocation;
	...
	public String getItemDisplayName(ItemStack is){
		...
		case 0:return "Wooden Paxelstick";
		case 1:return "Stone Paxelstick";
		case 2:return "Iron Paxelstick";
		case 3:return "Diamond Paxelstick";
		case 4:return "Gold PaxelStick";
